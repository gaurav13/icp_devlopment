...
shared ({ caller = initializer }) actor class () {
  ...
  public shared ({ caller }) func addSubscriber(author : Principal, userCanisterId : Text, commentCanisterId : Text,name:Text) : async Result.Result<(Subscriber, Text), Text> {
        ...
        case (?oldSubscribers) {
          ...
          switch (isSubscribed) {
            ...
            case (null) {
              ...
              let activitied = commentCanister.addActivity(caller, authorId, #subscribe,name);
