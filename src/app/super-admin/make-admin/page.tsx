            ...
            <div className='section admin-inner-pnl' id='top'>
              <Row>
                <Col xl='9' lg='12' className='text-left'>
                  <h1>
                    Admin Management <i className='fa fa-arrow-right' />{' '}
                    ...
                    onSubmit={async (values, { resetForm, setFieldValue }) => {
                      ...
                      if (assigned?.ok) {
                        ...
                        if (role.hasOwnProperty('user_admin')) {
                          ...
                          toast.success(
                            `Content management rights have been granted to "${user.name[0]}" `
                          );
                        } else if (role.hasOwnProperty('sub_admin')) {
                          toast.success(
                            `User & Content management rights have been granted to "${user.name[0]}" `
                          );
                        } else if (role.hasOwnProperty('sub_admin')) {
                          toast.success(
