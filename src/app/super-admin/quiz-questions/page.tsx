...
export default function QuizListPage() {
  ...
  // let tempValidate = async () => {
  //   let ans = [{ title: 'tttttttttt', correctAnswer: ['2'] }];
  //   const resp = await entryActor.validateQuiz(
  //     '1713510392579484653',
  //     2,
  //     ans,
  //     userCanisterId
  //   );
  //   logger(resp, 'asfafsdgdsfsadasdxxcxzczxcz');
  // };
  useEffect(() => {
            ...
            <div className='section admin-inner-pnl' id='top'>
              <Row>
                <Col xl='12' lg='12' md='12'>
                  <Breadcrumb>
                    <Breadcrumb.Item>
                      <Link href='/super-admin/manage-quiz'>
