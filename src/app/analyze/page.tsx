...
import { ALL_SURVEY_ROUTE_USER, MANAGE_SURVEY_ADMIN } from '@/constant/routes';
...
export default function QuizListPage() {
  ...
  let servayId = searchParams.get('servayId');
      ...
      <main id='main' className='dark'>
        <div className='main-inner admin-main'>
          <div className='section admin-inner-pnl' id='top'>
            <Row>
              <Col xl='12' lg='12' md='12'>
                <Breadcrumb>
                  ...
                  <Breadcrumb.Item
                    href={`/survey-questions?SurveyId=${servayId}`}
                  >
                    {'Survey-questions'}
                  </Breadcrumb.Item>
                  {servayName && (
            ...
            <Row>{report && <ServayQustionReportchart report={report} />}</Row>
          </div>
        </div>
      </main>
    </>
