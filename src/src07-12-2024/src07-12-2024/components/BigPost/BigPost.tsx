  ...
  return (
    <>
      <div className='big-post scroll-anime'>
          ...
          <div className='Product-post-inner'>
            <div className='img-pnl'>
              ...
              <div className='absolute-pnl'>
                <div>
                  <span>
                    <Image src={iconhyper} alt='Post' /> Hyperretina
                  </span>
                ...
                <div>
                  ...
                  <Link href='/' className='dark-btn-small'>
                    Mint
                  </Link>
                </div>
              </div>
        ...
        <h4>
          Video games, both culturally and visually, have sparked the
          imagination of countless artists. Yet, when an artistVideo games, both
          culturally and visually, have sparked the imagination of countless
          artists. Yet, when an artistVideo games, both culturally and visually,
          have sparked the imagination of countless artists. Yet, when an artist
        </h4>
        <h4>
          Video games, both culturally and visually, have sparked the
          imagination of countless artists. Yet, when an artistVideo games, both
